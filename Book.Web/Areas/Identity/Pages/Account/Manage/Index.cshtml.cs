...
namespace Book.Web.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
			...
			[Required,MaxLength(100, ErrorMessage = Errors.MaxLenght), Display(Name = "Full Name"),
	        RegularExpression(RegexPatterns.CharactersOnly_Eng, ErrorMessage = Errors.onlyEnglishLetters)]
			public string FullName { get; set; } = null!;

			[Phone]
            [Display(Name = "Phone number"),MaxLength(11,ErrorMessage =Errors.MaxLenght),
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if(Input.Avatar is not null)
            {
                ...
                var (isUploaded, errorMessage) = await _imageService.uploadAsync(image: Input.Avatar, imageName: $"{user.Id}.png", folderPath: "/images/users",hasThumbnail:false);
