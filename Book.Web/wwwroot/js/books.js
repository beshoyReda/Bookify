$(document).ready(function () {
    ...
    datatable = $('#Books').DataTable({
        ...
        columns: [
            { "data": "bookId", "name": "BookId", "className": "d-none" },
            {
                "name": "Title",
                ...
                "render": function (data, type, row) {
                    return `<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                            ...
                            <div class="menu-item px-3">
                                <a href="/Books/Edit/${row.bookId}" class="menu-link px-3">
                                    Edit
                                </a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                        <a href="javascript:;" class="menu-link flex-stack px-3 js-toggle-status" data-url="/Books/ToggleStatus/${row.bookId}">
                                    Toggle Status
                                </a>
                            </div>
                            <!--end::Menu item-->
