...
namespace Book.Web.Controllers
{
    ...
    public class UsersController : Controller
    {
		...
		public async Task<IActionResult> Index()
        {
            ...
            //await _emailSender.SendEmailAsync("beshoy2000111@hotmail.com", "Test Email", body);
        ...
        public async Task<IActionResult> Create(UserFormViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var body = _emailBodyBuilder.GetEmailBody(
					"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPxhABugSbzogKVWtMOsCdmCYT8BCVTa_8sdEVhLYV1A&s",
        ...
        public async Task<IActionResult>Edit(UserFormViewModel model)
        {
            ...
            if(result.Succeeded)
            {
                ...
                var roleUpdated = !currentRoles.SequenceEqual(model.SelectedRoles);
                if(roleUpdated)
                {
